FC = mpif90
FFLAGS = -O -xHost -fpp -ftz -Dparallel_int -Dsimple_timer -Dprocformat -fp-model precise -align array32byte -Duselastrip -Dusefirstrank -Dsingleget
#FFLAGS = -O -xHost -fpp -ftz -Dsimple_timer -Dprocformat
...
mpidata_m.o stacklimit.o shdata_m.o logging_m.o
...
cc2hist_work.o: moistfuncs.o staguv_m.o vertutils_m.o parm_m.o interp_m.o setxyz_m.o latltoij_m.o indices_m.o xyzinfo_m.o newmpar_m.o sitop_m.o height_m.o physparams.o s2p_m.o history.o gldata_m.o ncutils_m.o precis_m.o mpidata_m.o shdata_m.o logging_m.o

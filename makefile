...
FHOST = -xHost
ifeq ($(BROADWELL),yes)
FHOST = -xCORE-AVX2 -align array32byte -fimf-use-svml -Dsafe
endif
ifeq ($(SKYLAKE),yes)
FHOST = -xSKYLAKE-AVX512 -align array64byte -fimf-use-svml -Dsafe
endif
...
MPIF77 = ftn
FC = ftn
FFLAGS = -O2 -mtune=native -march=native -fbacktrace -Dncclib -fallow-argument-mismatch -Dusempi3 -Dsafe
INC =
LIBS = -lnetcdf
PPFLAG90 = -x f95-cpp-input
DEBUGFLAG = -g -Wall -Wextra -fbounds-check

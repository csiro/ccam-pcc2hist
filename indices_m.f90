...
module indices_m
   implicit none
#ifdef parallel_int
   integer, public, dimension(:), pointer, contiguous :: i_n, i_s, i_w, i_e,         &
#else
   integer, public, dimension(:), allocatable :: i_n, i_s, i_w, i_e,         &
                                                 ...
                                                 i_eu, i_nv 
#ifdef parallel_int
   integer, public, dimension(:,:), pointer, contiguous :: i_ewns
#endif

#ifdef parallel_int
   integer, public, dimension(:), pointer, contiguous :: lwws, lws, lwss, les, lees, &
#else
